<template>
  <div>
    <div style="padding: 10px 0">
      <el-input style="width: 200px" placeholder="请输入课号" suffix-icon="el-icon-search" v-model="courseId"></el-input>
      <el-input style="width: 200px" placeholder="请输入课程名称" suffix-icon="el-icon-search" class="ml-5" v-model="name"></el-input>
      <el-input style="width: 200px" placeholder="请输入学分" suffix-icon="el-icon-search" class="ml-5" v-model="credit"></el-input>
      <el-input style="width: 200px" placeholder="请输入学时" suffix-icon="el-icon-search" class="ml-5" v-model="creditHour"></el-input>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="headerBg" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="dptId" label="院系号"></el-table-column>
    ...
    <el-dialog title="学生信息" :visible.sync="dialogFormVisible">
      <el-form label-width="60px" size="small">
        ...
        <el-form-item label="学时">
          <el-input v-model="form.creditHour" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="院系号">
          <el-select v-model="form.dptId" placeholder="请选择院系">
            <el-option
  ...
  methods: {
    ...
    del(id) {
      this.request.delete(`/course/${id}`).then(res => {
        ...
        this.$message.error("无法删除该课程，存在关联的开课记录");
      });
    },
