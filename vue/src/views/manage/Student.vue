<template>
  <div>
    <div style="padding: 10px 0">
      ...
      <el-input style="width: 200px" placeholder="请输入学生姓名" suffix-icon="el-icon-search" class="ml-5" v-model="name"></el-input>
      <el-input style="width: 200px" placeholder="请输入学生学号" suffix-icon="el-icon-search" class="ml-5" v-model="code"></el-input>
      <el-input style="width: 200px" placeholder="请输入学生专业ID" suffix-icon="el-icon-search" class="ml-5" v-model="collegeId"></el-input>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="headerBg" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="collegeId" label="学院ID"></el-table-column>
